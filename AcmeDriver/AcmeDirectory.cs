...
namespace AcmeDriver {
    public class AcmeDirectory {
        ...
        public Uri RevokeCertUrl { get; set; } = default!;

        ///<summary>
        ///<para>Introduced in https://tools.ietf.org/html/draft-ietf-acme-acme-03</para>
        ///</summary>
        [JsonPropertyName("keyChange")]
        public Uri KeyChangeUrl { get; set; } = default!;

        [JsonPropertyName("meta")]
        public AcmeDirectoryMeta Meta { get; set; } = default!;
